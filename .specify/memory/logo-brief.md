...
- **Style:** Single continuous line illustration, minimalist geometric

---

## Reference Logos (User Favorites)

1. **Crumbl** — Line art character (bakerhead) in circle, works in B&W
2. **Meta** — Geometric infinity symbol, elegant simplicity
3. **Airbnb (Bélo)** — Simple geometric symbol, universal meaning
...
Sophisticated and timeless like Crumbl cookie logo. Clean edges, 
no gradients, no text, no background elements. Simple iconic 
design suitable for app icon. White background.
...
- [ ] Works in solid white  
- [ ] Recognizable at 32x32px (favicon)
- [ ] Looks good at 512x512px (app icon)
- [ ] Pairs well with Outfit wordmark
- [ ] Conveys "friendly food planning"
- [ ] Timeless (no trendy elements)
- [ ] Vector-ready (clean edges)

---

## Workflow

1. ✅ Define character direction (speaking plate)
2. ✅ Choose AI tool (Midjourney)
3. ✅ Craft prompts
4. ⏳ User: Get Midjourney access
5. ⏳ Generate batches of concepts
6. ⏳ Select top candidates
7. ⏳ Refine with variations (V1, V2, etc.)
8. ⏳ Test in B&W
9. ⏳ Upscale final choice
10. ⏳ Vectorize (trace in Figma/Illustrator)
11. ⏳ Pair with Outfit wordmark
12. ⏳ Export all sizes for app
...
- Each generation produces 4 variations
